#ifndef mip_knob2b_widget_included
#define mip_knob2b_widget_included
//----------------------------------------------------------------------
...
//------------------------------
  ...
  MIP_Knob2bWidget(MIP_FRect ARect, const char* AName="")
  : MIP_Widget(ARect) {
