...
//------------------------------
  ...
  : MIP_PanelWidget(ARect) {
    ...
    MLabelWidget->Layout.horizScale = MIP_WIDGET_SIZE_PARENT_RATIO;
    MLabelWidget->Layout.vertScale = MIP_WIDGET_SIZE_PARENT_RATIO;
    ...
    MValueWidget->Layout.horizScale = MIP_WIDGET_SIZE_PARENT_RATIO;
    MValueWidget->Layout.vertScale = MIP_WIDGET_SIZE_PARENT_RATIO;
