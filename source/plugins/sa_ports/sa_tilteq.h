...
//------------------------------
  ...
  void recalc() {
    ...
    //switch(index) {
    //  case 0: // slider1
        mono = MIP_Trunc(MParameterValues[0]);
    //    break;
    //  case 1: // slider2
        sx = 16 + MParameterValues[1] * 1.20103;
    ...
    //    break;
    //  case 3: // slider4
        outgain = exp(MParameterValues[3]/amp);
    //    break;
    //}
  }
...
//------------------------------
  ...
  bool init() final {
    ...
    appendParameter(new MIP_TextParameter( 0, CLAP_PARAM_IS_AUTOMATABLE, "Processing",  "",  0,   1,    0, str_proc ));
    appendParameter(new MIP_Parameter(     1, CLAP_PARAM_IS_AUTOMATABLE, "Center Freq", "",  0,   100,  50          ));
    appendParameter(new MIP_Parameter(     2, CLAP_PARAM_IS_AUTOMATABLE, "Tilt",        "", -6,   6,    0           ));
    appendParameter(new MIP_Parameter(     3, CLAP_PARAM_IS_AUTOMATABLE, "Gain",        "", -25,  25,   0           ));
