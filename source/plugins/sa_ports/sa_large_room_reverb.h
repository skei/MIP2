...
const clap_plugin_descriptor_t sa_large_room_reverb_descriptor = {
  CLAP_VERSION,
  "skei.audio/sa_large_room_reverb/0.0.1",
...
//------------------------------
  ...
  void recalc(float srate) {
      wet = exp(MParameterValues[1]/8.65617);
      dry = exp(MParameterValues[0]/8.65617);
      g = 1-MParameterValues[2]/100;
      a0 = 0;
      a0_len = (srate*8/1000);
      a0_g = 0.3;
      a1 = a0+a0_len+1;
...
//------------------------------
  ...
  bool init() final {
    ...
    appendParameter(new MIP_Parameter( 0, CLAP_PARAM_IS_AUTOMATABLE, "Dry",     "",  -120, 0,    0  ));
    appendParameter(new MIP_Parameter( 1, CLAP_PARAM_IS_AUTOMATABLE, "Wet",     "",  -120, 0,   -6  ));
    appendParameter(new MIP_Parameter( 2, CLAP_PARAM_IS_AUTOMATABLE, "Damping", "",   0,   100,  50 ));
