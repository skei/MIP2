...
//------------------------------
  ...
  void recalc(float srate) {
    ...
    float treshDB = MParameterValues[0];
    float ratio   = MParameterValues[1];
...
//------------------------------
  ...
  bool init() final {
    appendParameter(new MIP_Parameter( 0, CLAP_PARAM_IS_AUTOMATABLE, "Threshold", "",  -12, 1,  0 ));
    appendParameter(new MIP_Parameter( 1, CLAP_PARAM_IS_AUTOMATABLE, "Ratio",     "",   1,  50, 1 ));
