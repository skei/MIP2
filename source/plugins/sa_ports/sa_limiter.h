...
//------------------------------
  ...
  void recalc(float srate) {
    ...
    thresh    = powf(10,(MParameterValues[0]/20));
    make_gain = powf(10,((-MParameterValues[0]+MParameterValues[1])/20));
    ceiling   = powf(10,(MParameterValues[1]/20));
...
//------------------------------
  ...
  bool init() final {
    ...
    appendParameter(new MIP_Parameter( 1, CLAP_PARAM_IS_AUTOMATABLE, "Ceiling",   "",  -30, 0, 0 ));
