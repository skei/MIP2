...
const clap_plugin_descriptor_t sa_hall_reverb_descriptor = {
  CLAP_VERSION,
  "skei.audio/sa_hall_reverb/0.0.1",
  "sa_hall_reverb",
  "skei.audio",
...
//------------------------------
  ...
  void recalc(float srate) {
    l0   = floorf( MParameterValues[3]/1000*srate+1 );
    l1   = 3;
    l2   = 13;
    l3   = 31;
    l4   = 103;
    ...
    l11  = 1213;
    l12  = 1553;
    Rl0  = floorf( MParameterValues[3]/1000*srate+1 );
    Rl1  = 3;
    Rl2  = 11;
    Rl3  = 37;
    Rl4  = 113;
    ...
    g9  = 0.62;
    g11 = 0.62;
    f   = expf( logf(0.001) / ( MParameterValues[2]*srate / (l5+l6+l7+l8) ) );
    d   = expf( -2*MIP_PI*18000/srate );
    dry = powf(10,(MParameterValues[0]/20)); // 10^(slider1/20);
    wet = powf(10,(MParameterValues[1]/20)); // 10^(slider2/20);
    need_recalc = false;
  }
...
//------------------------------
  ...
  bool init() final {
    ...
    appendParameter(new MIP_Parameter( 0, CLAP_PARAM_IS_AUTOMATABLE, "Dry",      "", -48,   0,    0  ));
    appendParameter(new MIP_Parameter( 1, CLAP_PARAM_IS_AUTOMATABLE, "Wet",      "", -48,   0,   -12 ));
    appendParameter(new MIP_Parameter( 2, CLAP_PARAM_IS_AUTOMATABLE, "Length",   "",  0.01, 3,    1  ));
    appendParameter(new MIP_Parameter( 3, CLAP_PARAM_IS_AUTOMATABLE, "PreDelay", "",  0,    100,  10  ));
