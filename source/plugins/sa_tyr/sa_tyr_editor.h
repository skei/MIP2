...
// ----- osc1
      ...
      osc1_panel->setBackgroundColor(0.55);
        ...
        osc1_cent_slider->setSnapDist(0.1);
...
// ----- res1 -----
      ...
      controls->appendChildWidget(res1_panel);
        ...
        res1_cent_slider->setSnapDist(0.1);
...
// ----- osc2
      ...
      osc2_panel->setBackgroundColor(0.55);
        ...
        osc2_cent_slider->setSnapDist(0.1);
...
// ----- res2 -----
      ...
      controls->appendChildWidget(res2_panel);
        ...
        res2_type_selector->setSelected(0);
        ...
        res2_cent_slider->setSnapDist(0.1);
