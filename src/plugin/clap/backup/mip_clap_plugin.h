...
//------------------------------
  ...
  const clap_plugin_descriptor* MClapDescriptor = nullptr;
...
//------------------------------
  ...
  MIP_ClapPlugin(const clap_plugin_descriptor* desc, const clap_host* host) {
    MClapDescriptor = desc;
    MClapHost       = host;
  }
...
//------------------------------
  ...
  struct clap_plugin MClapPlugin = {
    MClapDescriptor,
    this,
